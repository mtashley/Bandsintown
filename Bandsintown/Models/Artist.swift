...
@objc class Artist : NSObject {
    ...
    init(name: String, media_id: Int? = 0, thumb_url: String? = "", image_url: String? = "", tracker_count: Int? = 0, upcomingEventCount: Int? = 0) {
        self.name = name
    ...
    init(jsonObject: JSON) {
        ...
        self.image_url = jsonObject["image_url"].string!

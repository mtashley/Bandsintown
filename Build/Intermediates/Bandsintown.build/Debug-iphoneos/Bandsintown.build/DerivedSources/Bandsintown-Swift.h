...
SWIFT_MODULE_NAMESPACE_PUSH("Bandsintown")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC11Bandsintown11AppDelegate")
...
SWIFT_CLASS("_TtC11Bandsintown6Artist")
...
SWIFT_CLASS("_TtC11Bandsintown19ArtistTableViewCell")
...
- (IBAction)handleTappedFavoriteButton:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC11Bandsintown11DataManager")
...
@property (nonatomic, weak) id <DataManagerDelegate> _Null_unspecified delegate;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_PROTOCOL("_TtP11Bandsintown19DataManagerDelegate_")
@protocol DataManagerDelegate
@optional
- (void)reloadData;
- (void)presentArtistDetailsWith:(Artist * _Nonnull)artist;
@end

@class NSEntityDescription;
@class NSManagedObjectContext;

SWIFT_CLASS_NAMED("FavoriteArtist")
@interface FavoriteArtist : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface FavoriteArtist (SWIFT_EXTENSION(Bandsintown))
@property (nonatomic) int64_t media_id;
@property (nonatomic, copy) NSString * _Nullable name;
@property (nonatomic, copy) NSString * _Nullable thumb_url;
@end
